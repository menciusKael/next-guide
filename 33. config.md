...
Rewriting allows you to map the incoming request path to another target path. It is different from redirection in that rewriting is equivalent to playing the role of URL proxy, which will shield the target path. The address is still the same, but the routing logic has changed. Redirection, on the other hand, navigates to a new page, and the URL in the browser will also change. To configure redirection, use `rewrites` of `next.config.js`, as shown below:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/about&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
Rewrites are applied to client-side routes, in this case, if you use `<Link href="/about">`, rewrites will be applied.

`rewrites` is an asynchronous function that can return an array of objects containing `source`, `destination` properties, where:

- `source` represents the incoming request path
- `destination` represents the target path you rewrite to
- `basePath`: `false` or `undefined`. When the value is `false`, `basePath` will not be included when matching, and can only be used for external rewrites
- `locale`: `false` or `undefined`, whether locale should be included when matching
- `has`: an array of objects with `type`, `key`, `value` properties
- `missing`: an array of objects with `type`, `key`, `value` properties

If this array is returned, rewrites will be applied after checking the file system (pages and /public files) and before dynamic routing.

You can also return an object with specific properties, which is for more fine-grained control, the sample code is as follows:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    return {</span>
<span class="code-block-extension-codeLine" data-line-num="5">      beforeFiles: [</span>
<span class="code-block-extension-codeLine" data-line-num="6">        // after headers/redirects </span>
<span class="code-block-extension-codeLine" data-line-num="7">        //  _next/public files bef oredispach</span>
<span class="code-block-extension-codeLine" data-line-num="8">        {</span>
<span class="code-block-extension-codeLine" data-line-num="9">          source: &#39;/some-page&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="10">          destination: &#39;/somewhere-else&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="11">          has: [{ type: &#39;query&#39;, key: &#39;overrideMe&#39; }],</span>
<span class="code-block-extension-codeLine" data-line-num="12">        },</span>
<span class="code-block-extension-codeLine" data-line-num="13">      ],</span>
<span class="code-block-extension-codeLine" data-line-num="14">      afterFiles: [</span>
<span class="code-block-extension-codeLine" data-line-num="15">        // pages/public </span>
<span class="code-block-extension-codeLine" data-line-num="16">        {</span>
<span class="code-block-extension-codeLine" data-line-num="17">          source: &#39;/non-existent&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="18">          destination: &#39;/somewhere-else&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="19">        },</span>
<span class="code-block-extension-codeLine" data-line-num="20">      ],</span>
<span class="code-block-extension-codeLine" data-line-num="21">      fallback: [</span>
<span class="code-block-extension-codeLine" data-line-num="22">        // </span>
<span class="code-block-extension-codeLine" data-line-num="23">        {</span>
<span class="code-block-extension-codeLine" data-line-num="24">          source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="25">          destination: `https://my-old-site.com/:path*`,</span>
<span class="code-block-extension-codeLine" data-line-num="26">        },</span>
<span class="code-block-extension-codeLine" data-line-num="27">      ],</span>
<span class="code-block-extension-codeLine" data-line-num="28">    }</span>
<span class="code-block-extension-codeLine" data-line-num="29">  },</span>
...
At this point, we have to talk about the order in which Next.js routes are checked:

1. headers
2. redirects
3. beforeFiles rewrite
4. Static files in the `public` directory, `_next/static` files, non-dynamic pages
5. afterFiles rewrite, if each match,
6. fallback rewrite, will be referenced before rendering the 404 page and before dynamic routes and all static resource checks

### 3.2. Rewrite parameters

If `destination` does not use parameters (`:path*` in the example), then the parameters in `source` will be passed to `destination` by default in the form of a query string (query):
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/old-about/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/about&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
Assume that the code of `app/about/page.js` is:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/about/page.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">export default function Page(props) {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  console.dir(props)</span>
<span class="code-block-extension-codeLine" data-line-num="4">  return  <span class="xml">&lt;h1&gt;Hello About!&lt;/h1&gt;</span></span>
<span class="code-block-extension-codeLine" data-line-num="5">}</span>
</code></pre>

Visit `/old-about/article?id=1`, and the printed value is:

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cf100c8b0fbc475b9a2472359b7e3190~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=900&h=36&s=49552&e=png&b=010509)

The article parameter in `source` can be found in searchParams.

If `destination` uses parameters, no parameters are automatically passed:
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/docs/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
Visit `/docs/about?id=1`, and the printed value is:

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4cef281c1d70417b9104f5ce57478ecd~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=602&h=48&s=41058&e=png&b=010508)

If `destination` takes arguments, you can still pass them manually:
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/:first/:second&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/:first?second=:second&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
In this example, because `destination` uses the `:first` parameter, the `:second` parameter will not be automatically added to the query, but we can add it manually as shown in the example so that it can be obtained in the query.

Visit `/about/article?id=1`, and the printed value is:

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6fceaf76a61f403b81e8cf524e622c9b~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=888&h=44&s=56783&e=png&b=010508)
...
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/blog/:slug*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/news/:slug*&#39;, // Matched parameters can be used in the destination</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
#### 3.3.3. Regular expression path matching
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/old-blog/:post(\\d{1,})&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;/blog/:post&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="10">  },</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        // this will match `/english(default)/something` being requested</span>
<span class="code-block-extension-codeLine" data-line-num="7">        source: &#39;/english\\(default\\)/:slug&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">        destination: &#39;/en-us/:slug&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="9">      },</span>
<span class="code-block-extension-codeLine" data-line-num="10">    ]</span>
...
When using `basePath`, each `source` and `destination` will automatically be prefixed with `basePath`, unless you set `basePath: false` for the override:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  basePath: &#39;/docs&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="4"></span>
<span class="code-block-extension-codeLine" data-line-num="5">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="6">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="7">      {</span>
<span class="code-block-extension-codeLine" data-line-num="8">        source: &#39;/with-basePath&#39;, // Automatically becomes /docs/with-basePath</span>
<span class="code-block-extension-codeLine" data-line-num="9">        destination: &#39;/another&#39;, // Automatically becomes  /docs/another</span>
<span class="code-block-extension-codeLine" data-line-num="10">      },</span>
<span class="code-block-extension-codeLine" data-line-num="11">      {</span>
<span class="code-block-extension-codeLine" data-line-num="12">        // Does not add /docs to /without-basePath because basePath is set to false </span>
<span class="code-block-extension-codeLine" data-line-num="13">        source: &#39;/without-basePath&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="14">        destination: &#39;https://example.com&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="15">        basePath: false,</span>
<span class="code-block-extension-codeLine" data-line-num="16">      },</span>
<span class="code-block-extension-codeLine" data-line-num="17">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="18">  },</span>
<span class="code-block-extension-codeLine" data-line-num="19">}</span>
...
When using `i18n`, each `source` and `destination` will automatically be prefixed with `locales`, unless you set `locale: false` for the override. If you set `locale: false`, you must use a `locale` as a prefix for `source` and `destination` to match correctly. Let's look at an example:
...
<span class="code-block-extension-codeLine" data-line-num="6">  },</span>
<span class="code-block-extension-codeLine" data-line-num="7"></span>
<span class="code-block-extension-codeLine" data-line-num="8">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="9">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="10">      {</span>
<span class="code-block-extension-codeLine" data-line-num="11">        // /with-locale -&gt; /another</span>
<span class="code-block-extension-codeLine" data-line-num="12">        // /en/with-locale -&gt; /en/another</span>
...
<span class="code-block-extension-codeLine" data-line-num="17">      },</span>
<span class="code-block-extension-codeLine" data-line-num="18">      {</span>
<span class="code-block-extension-codeLine" data-line-num="19">        // Because locale is set to false, it will not be automatically processed</span>
<span class="code-block-extension-codeLine" data-line-num="20">        // /nl/with-locale-manual -&gt; /nl/another</span>
<span class="code-block-extension-codeLine" data-line-num="21">        source: &#39;/nl/with-locale-manual&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="22">        destination: &#39;/nl/another&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="23">        locale: false,</span>
<span class="code-block-extension-codeLine" data-line-num="24">      },</span>
<span class="code-block-extension-codeLine" data-line-num="25">      {</span>
<span class="code-block-extension-codeLine" data-line-num="26">        // Because `en` is the defaultLocale, it matches &#39;/&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="27">        // /en -&gt; /en/another</span>
<span class="code-block-extension-codeLine" data-line-num="28">        // / -&gt; /en/another</span>
<span class="code-block-extension-codeLine" data-line-num="29">        source: &#39;/en&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="30">        destination: &#39;/en/another&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="31">        locale: false</span>
<span class="code-block-extension-codeLine" data-line-num="32">      },</span>
<span class="code-block-extension-codeLine" data-line-num="33">      // Matches all even if locale is set to falselocale</span>
<span class="code-block-extension-codeLine" data-line-num="34">      {</span>
<span class="code-block-extension-codeLine" data-line-num="35">        source: &#39;/:locale/api-alias/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="36">        destination: &#39;/api/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="37">        locale: false,</span>
<span class="code-block-extension-codeLine" data-line-num="38">      },</span>
<span class="code-block-extension-codeLine" data-line-num="39">      {</span>
<span class="code-block-extension-codeLine" data-line-num="40">        // Converts to /(en|fr|de)/(.*) so it will not match `/`</span>
<span class="code-block-extension-codeLine" data-line-num="41">        // /page -&gt; /another</span>
<span class="code-block-extension-codeLine" data-line-num="42">        // /fr/page -&gt; /fr/another</span>
<span class="code-block-extension-codeLine" data-line-num="43">        // To match `\` or `/fr` use/:path*</span>
<span class="code-block-extension-codeLine" data-line-num="44">				source: &#39;/(.*)&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="45">        destination: &#39;/another&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="46">      },</span>
<span class="code-block-extension-codeLine" data-line-num="47">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="48">  },</span>
<span class="code-block-extension-codeLine" data-line-num="49">}</span>
...
`has` and `missing` are used to process headers, cookies and request parameters in the request to see if they match certain fields, or if they do not match certain fields, before rewriting.

For example, for a request like `/article?id=1&author=yayu`, `has` can require that the request must contain an id parameter, or that the id parameter is equal to xxx before rewriting. `missing` can require that the request must not contain an id parameter, or that the id parameter is not equal to xxx before rewriting.

`has` and `missing` objects have the following fields:

- `type`: `String` type, value is one of `header`, `cookie`, `host`, `query`
- `key`: `String` type, key to match in the selected type (that is, the four values ​​above)
- `value`: `String` or `undefined`, the value to be checked. If the value is `undefiend`, no value will match. Supports using a regular expression-like string to capture special parts of the value. For example, `first-(?<paramName>.*)` is used to match `first-second`, and then `:paramName` can be used to get the value of `second`

It is actually the same as redirects, except that one is redirection and the other is rewriting.

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      // If the header `x-rewrite-me` exists,</span>
<span class="code-block-extension-codeLine" data-line-num="6">      // Rewrite will be applied</span>
<span class="code-block-extension-codeLine" data-line-num="7">      {</span>
<span class="code-block-extension-codeLine" data-line-num="8">        source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="9">        has: [</span>
<span class="code-block-extension-codeLine" data-line-num="10">          {</span>
<span class="code-block-extension-codeLine" data-line-num="11">            type: &#39;header&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="12">            key: &#39;x-rewrite-me&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="13">          },</span>
<span class="code-block-extension-codeLine" data-line-num="14">        ],</span>
<span class="code-block-extension-codeLine" data-line-num="15">        destination: &#39;/another-page&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="16">      },</span>
<span class="code-block-extension-codeLine" data-line-num="17">      // If `x-rewrite-me` does not exist</span>
<span class="code-block-extension-codeLine" data-line-num="18">      // Rewrite will be applied</span>
<span class="code-block-extension-codeLine" data-line-num="19">      {</span>
<span class="code-block-extension-codeLine" data-line-num="20">        source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="21">        missing: [</span>
<span class="code-block-extension-codeLine" data-line-num="22">          {</span>
<span class="code-block-extension-codeLine" data-line-num="23">            type: &#39;header&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="24">            key: &#39;x-rewrite-me&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="25">          },</span>
<span class="code-block-extension-codeLine" data-line-num="26">        ],</span>
<span class="code-block-extension-codeLine" data-line-num="27">        destination: &#39;/another-page&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="28">      },</span>
<span class="code-block-extension-codeLine" data-line-num="29">      // If source, query, and cookie match,</span>
<span class="code-block-extension-codeLine" data-line-num="30">      // Will apply rewrite</span>
<span class="code-block-extension-codeLine" data-line-num="31">      {</span>
<span class="code-block-extension-codeLine" data-line-num="32">        source: &#39;/specific/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="33">        has: [</span>
<span class="code-block-extension-codeLine" data-line-num="34">          {</span>
<span class="code-block-extension-codeLine" data-line-num="35">            type: &#39;query&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="36">            key: &#39;page&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="37">            value: &#39;home&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="38">          },</span>
<span class="code-block-extension-codeLine" data-line-num="39">          {</span>
<span class="code-block-extension-codeLine" data-line-num="40">            type: &#39;cookie&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="41">            key: &#39;authorized&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="42">            value: &#39;true&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="43">          },</span>
<span class="code-block-extension-codeLine" data-line-num="44">        ],</span>
<span class="code-block-extension-codeLine" data-line-num="45">        destination: &#39;/:path*/home&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="46">      },</span>
<span class="code-block-extension-codeLine" data-line-num="47">      // If the header `x-authorized` exists and is yes or true</span>
<span class="code-block-extension-codeLine" data-line-num="48">      // Rewrite will be applied</span>
<span class="code-block-extension-codeLine" data-line-num="49">      {</span>
<span class="code-block-extension-codeLine" data-line-num="50">        source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="51">        has: [</span>
<span class="code-block-extension-codeLine" data-line-num="52">          {</span>
<span class="code-block-extension-codeLine" data-line-num="53">            type: &#39;header&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="54">            key: &#39;x-authorized&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="55">            value: &#39;(?&lt;authorized&gt;yes|true)&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="56">          },</span>
<span class="code-block-extension-codeLine" data-line-num="57">        ],</span>
<span class="code-block-extension-codeLine" data-line-num="58">        destination: &#39;/home?authorized=:authorized&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="59">      },</span>
<span class="code-block-extension-codeLine" data-line-num="60">      // If host is `example.com`,</span>
<span class="code-block-extension-codeLine" data-line-num="61">      // Will apply rewrite</span>
<span class="code-block-extension-codeLine" data-line-num="62">      {</span>
<span class="code-block-extension-codeLine" data-line-num="63">        source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="64">        has: [</span>
<span class="code-block-extension-codeLine" data-line-num="65">          {</span>
<span class="code-block-extension-codeLine" data-line-num="66">            type: &#39;host&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="67">            value: &#39;example.com&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="68">          },</span>
<span class="code-block-extension-codeLine" data-line-num="69">        ],</span>
<span class="code-block-extension-codeLine" data-line-num="70">        destination: &#39;/another-page&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="71">      },</span>
<span class="code-block-extension-codeLine" data-line-num="72">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="73">  },</span>
<span class="code-block-extension-codeLine" data-line-num="74">}</span>
...
### 3.7. Rewrite to external URL

rewrites can rewrite to external URLs, which is particularly useful in projects that incrementally adopt Next.js. For example, this example rewrites all `/blog` routes in the application to external URLs:
...
<span class="code-block-extension-codeLine" data-line-num="4">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="5">      {</span>
<span class="code-block-extension-codeLine" data-line-num="6">        source: &#39;/blog&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">        destination: &#39;https://example.com/blog&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      },</span>
<span class="code-block-extension-codeLine" data-line-num="9">      {</span>
<span class="code-block-extension-codeLine" data-line-num="10">        source: &#39;/blog/:slug&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="11">        destination: &#39;https://example.com/blog/:slug&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="12">      },</span>
<span class="code-block-extension-codeLine" data-line-num="13">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="14">  },</span>
<span class="code-block-extension-codeLine" data-line-num="15">}</span>
...
If `trailingSlash:true` is set, you also need to insert a trailing slash in `source`. If the destination also requires a trailing slash, it should also be included in the `destination` parameter.

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  trailingSlash: true,</span>
<span class="code-block-extension-codeLine" data-line-num="4">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="5">    return [</span>
<span class="code-block-extension-codeLine" data-line-num="6">      {</span>
<span class="code-block-extension-codeLine" data-line-num="7">        source: &#39;/blog/&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">        destination: &#39;https://example.com/blog/&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="9">      },</span>
<span class="code-block-extension-codeLine" data-line-num="10">      {</span>
<span class="code-block-extension-codeLine" data-line-num="11">        source: &#39;/blog/:path*/&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="12">        destination: &#39;https://example.com/blog/:path*/&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="13">      },</span>
<span class="code-block-extension-codeLine" data-line-num="14">    ]</span>
<span class="code-block-extension-codeLine" data-line-num="15">  },</span>
<span class="code-block-extension-codeLine" data-line-num="16">}</span>
...
### 3.8. Incremental adoption of Next.js

You can have Next.js proxy your existing site if there is no corresponding route after checking all Next.js routes. This way, you don't need to rewrite the configuration when you migrate more pages to Next.js:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div><span class="code-block-extension-lang">javascript</span></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// next.config.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">module.exports = {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  async rewrites() {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    return {</span>
<span class="code-block-extension-codeLine" data-line-num="5">      fallback: [</span>
<span class="code-block-extension-codeLine" data-line-num="6">        {</span>
<span class="code-block-extension-codeLine" data-line-num="7">          source: &#39;/:path*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">          destination: `https://custom-routes-proxying-endpoint.vercel.app/:path*`,</span>
<span class="code-block-extension-codeLine" data-line-num="9">        },</span>
<span class="code-block-extension-codeLine" data-line-num="10">      ],</span>
<span class="code-block-extension-codeLine" data-line-num="11">    }</span>
<span class="code-block-extension-codeLine" data-line-num="12">  },</span>
<span class="code-block-extension-codeLine" data-line-num="13">}</span></code></pre>
