...
## 2. Frequently Asked Questions about Writing Interfaces

Next, we will talk about some problems that are often encountered when writing interfaces, such as how to obtain URL parameters and how to read cookies. You can understand various methods. Just check it again when you encounter problems during actual development.

### 2.1. How to obtain URL parameters?

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/search/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">// 访问 /api/search?query=hello</span>
<span class="code-block-extension-codeLine" data-line-num="3">export function GET(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="4">  const searchParams = request.nextUrl.searchParams</span>
<span class="code-block-extension-codeLine" data-line-num="5">  const query = searchParams.get(&#39;query&#39;) // query</span>
<span class="code-block-extension-codeLine" data-line-num="6">}</span>
</code></pre>

### 2.2. How to deal with cookies?

The first way is through the `NextRequest` object:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">export async function GET(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  const token = request.cookies.get(&#39;token&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="4">  request.cookies.set(`token2`, 123)</span>
<span class="code-block-extension-codeLine" data-line-num="5">}</span>
</code></pre>

Among them, `request` is a `NextRequest` object. As mentioned in the previous section, `NextRequest` provides more convenient usage than `Request`. This is an example.

Additionally, although we set the cookie using set, the request cookie is set and the response cookie is not set.

The second method is through the `cookies` method provided by the `next/headers` package.

Because cookies instances are read-only, if you want to set a cookie, you need to return a Response instance using the `Set-Cookie` header. The sample code is as follows:
...
<span class="code-block-extension-codeLine" data-line-num="6">  const token = cookieStore.get(&#39;token&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="7"></span>
<span class="code-block-extension-codeLine" data-line-num="8">  return new Response(&#39;Hello, Next.js!&#39;, {</span>
<span class="code-block-extension-codeLine" data-line-num="9">    status: 200,</span>
<span class="code-block-extension-codeLine" data-line-num="10">    headers: { &#39;Set-Cookie&#39;: `token=${token}` },</span>
<span class="code-block-extension-codeLine" data-line-num="11">  })</span>
<span class="code-block-extension-codeLine" data-line-num="12">}</span>
</code></pre>

### 2.3. How to deal with Headers?

The first way is through the `NextRequest` object:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">export async function GET(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  const headersList = new Headers(request.headers)</span>
<span class="code-block-extension-codeLine" data-line-num="4">  const referer = headersList.get(&#39;referer&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="5">}</span>
</code></pre>

The second method is the `headers` method provided by the `next/headers` package.

Because headers instances are read-only, if you want to set headers, you need to return a Response instance with the new headers. Usage examples are as follows:
...
<span class="code-block-extension-codeLine" data-line-num="8">  return new Response(&#39;Hello, Next.js!&#39;, {</span>
<span class="code-block-extension-codeLine" data-line-num="9">    status: 200,</span>
<span class="code-block-extension-codeLine" data-line-num="10">    headers: { referer: referer },</span>
<span class="code-block-extension-codeLine" data-line-num="11">  })</span>
<span class="code-block-extension-codeLine" data-line-num="12">}</span>
</code></pre>
...
Redirect uses the `redirect` method provided by `next/navigation`. The example is as follows:
...
<span class="code-block-extension-codeLine" data-line-num="4">  redirect(&#39;https://nextjs.org/&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="5">}</span>
</code></pre>

### 2.5. How to obtain the request body content?

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/items/route.js </span>
<span class="code-block-extension-codeLine" data-line-num="2">import { NextResponse } from &#39;next/server&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="3"></span>
<span class="code-block-extension-codeLine" data-line-num="4">export async function POST(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="5">  const res = await request.json()</span>
<span class="code-block-extension-codeLine" data-line-num="6">  return NextResponse.json({ res })</span>
<span class="code-block-extension-codeLine" data-line-num="7">}</span>
</code></pre>

If the request body is of type FormData:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/items/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">import { NextResponse } from &#39;next/server&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="3"></span>
<span class="code-block-extension-codeLine" data-line-num="4">export async function POST(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="5">  const formData = await request.formData()</span>
<span class="code-block-extension-codeLine" data-line-num="6">  const name = formData.get(&#39;name&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="7">  const email = formData.get(&#39;email&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="8">  return NextResponse.json({ name, email })</span>
<span class="code-block-extension-codeLine" data-line-num="9">}</span>
</code></pre>

### 2.6. How to set up CORS?

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/route.ts</span>
<span class="code-block-extension-codeLine" data-line-num="2">export async function GET(request) {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  return new Response(&#39;Hello, Next.js!&#39;, {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    status: 200,</span>
<span class="code-block-extension-codeLine" data-line-num="5">    headers: {</span>
<span class="code-block-extension-codeLine" data-line-num="6">      &#39;Access-Control-Allow-Origin&#39;: &#39;*&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="7">      &#39;Access-Control-Allow-Methods&#39;: &#39;GET, POST, PUT, DELETE, OPTIONS&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="8">      &#39;Access-Control-Allow-Headers&#39;: &#39;Content-Type, Authorization&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="9">    },</span>
<span class="code-block-extension-codeLine" data-line-num="10">  })</span>
<span class="code-block-extension-codeLine" data-line-num="11">}</span>
</code></pre>

### 2.7. How to respond to no UI content?

You can return content without UI. In this example, when accessing `/rss.xml`, the contents of the XML structure will be returned:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/rss.xml/route.ts</span>
<span class="code-block-extension-codeLine" data-line-num="2">export async function GET() {</span>
<span class="code-block-extension-codeLine" data-line-num="3">  return new Response(`&lt;?xml version=&#34;1.0&#34; encoding=&#34;UTF-8&#34; ?&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="4">&lt;rss version=&#34;2.0&#34;&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="5"></span>
<span class="code-block-extension-codeLine" data-line-num="6">&lt;channel&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="7">  &lt;title&gt;Next.js Documentation&lt;/title&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="8">  &lt;link&gt;https://nextjs.org/docs&lt;/link&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="9">  &lt;description&gt;The React Framework for the Web&lt;/description&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="10">&lt;/channel&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="11"></span>
<span class="code-block-extension-codeLine" data-line-num="12">&lt;/rss&gt;`)</span>
<span class="code-block-extension-codeLine" data-line-num="13">}</span>
</code></pre>

Note: Next.js has provided built-in support for special files such as `sitemap.xml`, `robots.txt`, `app icons` and `open graph images`. We will discuss these contents in ["Metadata Chapter | Based on document"]

### 2.8. Streaming

Openai uses streams behind its typing effects:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/chat/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">import OpenAI from &#39;openai&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="3">import { OpenAIStream, StreamingTextResponse } from &#39;ai&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="4"></span>
<span class="code-block-extension-codeLine" data-line-num="5">const openai = new OpenAI({</span>
<span class="code-block-extension-codeLine" data-line-num="6">  apiKey: process.env.OPENAI_API_KEY,</span>
<span class="code-block-extension-codeLine" data-line-num="7">})</span>
<span class="code-block-extension-codeLine" data-line-num="8"></span>
<span class="code-block-extension-codeLine" data-line-num="9">export const runtime = &#39;edge&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="10"></span>
<span class="code-block-extension-codeLine" data-line-num="11">export async function POST(req) {</span>
<span class="code-block-extension-codeLine" data-line-num="12">  const { messages } = await req.json()</span>
<span class="code-block-extension-codeLine" data-line-num="13">  const response = await openai.chat.completions.create({</span>
<span class="code-block-extension-codeLine" data-line-num="14">    model: &#39;gpt-3.5-turbo&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="15">    stream: true,</span>
<span class="code-block-extension-codeLine" data-line-num="16">    messages,</span>
<span class="code-block-extension-codeLine" data-line-num="17">  })</span>
<span class="code-block-extension-codeLine" data-line-num="18"></span>
<span class="code-block-extension-codeLine" data-line-num="19">  const stream = OpenAIStream(response)</span>
<span class="code-block-extension-codeLine" data-line-num="20"></span>
<span class="code-block-extension-codeLine" data-line-num="21">  return new StreamingTextResponse(stream)</span>
<span class="code-block-extension-codeLine" data-line-num="22">}</span>
</code></pre>

Of course, you can also directly use the underlying Web API to implement Streaming:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// app/api/route.js</span>
<span class="code-block-extension-codeLine" data-line-num="2">// https://developer.mozilla.org/docs/Web/API/ReadableStream#convert_async_iterator_to_stream</span>
<span class="code-block-extension-codeLine" data-line-num="3">function iteratorToStream(iterator) {</span>
<span class="code-block-extension-codeLine" data-line-num="4">  return new ReadableStream({</span>
<span class="code-block-extension-codeLine" data-line-num="5">    async pull(controller) {</span>
<span class="code-block-extension-codeLine" data-line-num="6">      const { value, done } = await iterator.next()</span>
<span class="code-block-extension-codeLine" data-line-num="7"></span>
<span class="code-block-extension-codeLine" data-line-num="8">      if (done) {</span>
<span class="code-block-extension-codeLine" data-line-num="9">        controller.close()</span>
<span class="code-block-extension-codeLine" data-line-num="10">      } else {</span>
<span class="code-block-extension-codeLine" data-line-num="11">        controller.enqueue(value)</span>
<span class="code-block-extension-codeLine" data-line-num="12">      }</span>
<span class="code-block-extension-codeLine" data-line-num="13">    },</span>
<span class="code-block-extension-codeLine" data-line-num="14">  })</span>
<span class="code-block-extension-codeLine" data-line-num="15">}</span>
<span class="code-block-extension-codeLine" data-line-num="16"></span>
<span class="code-block-extension-codeLine" data-line-num="17">function sleep(time) {</span>
<span class="code-block-extension-codeLine" data-line-num="18">  return new Promise((resolve) =&gt; {</span>
<span class="code-block-extension-codeLine" data-line-num="19">    setTimeout(resolve, time)</span>
<span class="code-block-extension-codeLine" data-line-num="20">  })</span>
<span class="code-block-extension-codeLine" data-line-num="21">}</span>
<span class="code-block-extension-codeLine" data-line-num="22"></span>
<span class="code-block-extension-codeLine" data-line-num="23">const encoder = new TextEncoder()</span>
<span class="code-block-extension-codeLine" data-line-num="24"></span>
<span class="code-block-extension-codeLine" data-line-num="25">async function* makeIterator() {</span>
<span class="code-block-extension-codeLine" data-line-num="26">  yield encoder.encode(&#39;&lt;p&gt;One&lt;/p&gt;&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="27">  await sleep(200)</span>
<span class="code-block-extension-codeLine" data-line-num="28">  yield encoder.encode(&#39;&lt;p&gt;Two&lt;/p&gt;&#39;)</span>
<span class="code-block-extension-codeLine" data-line-num="29">  await sleep(200)</span>
<span class="code-block-extension-codeLine" data-line-num="30">  yield encoder.encode(&#39;&lt;p&gt;Three&lt;/p&gt;&#39;)</span>
