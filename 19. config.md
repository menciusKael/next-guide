...
In addition to configuring the 'baseURL' path, you can also set the 'paths' option to implement path aliases. for instance:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// tsconfig.json or jsconfig.json</span>
<span class="code-block-extension-codeLine" data-line-num="2">{</span>
<span class="code-block-extension-codeLine" data-line-num="3">  &#34;compilerOptions&#34;: {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    &#34;baseUrl&#34;: &#34;.&#34;,</span>
<span class="code-block-extension-codeLine" data-line-num="5">    &#34;paths&#34;: {</span>
<span class="code-block-extension-codeLine" data-line-num="6">      &#34;@/components/*&#34;: [&#34;components/*&#34;]</span>
<span class="code-block-extension-codeLine" data-line-num="7">    }</span>
<span class="code-block-extension-codeLine" data-line-num="8">  }</span>
<span class="code-block-extension-codeLine" data-line-num="9">}</span>
</code></pre>

In this example, we set a path mapping from '@/components/_' to 'components/_'.
...
Now we don't need to use relative addresses, just use the set path alias:
...
What is the relationship between baseURL and paths? In fact, the addresses in 'paths' are relative to' baseURL '. For example:

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">// tsconfig.json or jsconfig.json</span>
<span class="code-block-extension-codeLine" data-line-num="2">{</span>
<span class="code-block-extension-codeLine" data-line-num="3">  &#34;compilerOptions&#34;: {</span>
<span class="code-block-extension-codeLine" data-line-num="4">    &#34;baseUrl&#34;: &#34;src/&#34;,</span>
<span class="code-block-extension-codeLine" data-line-num="5">    &#34;paths&#34;: {</span>
<span class="code-block-extension-codeLine" data-line-num="6">      &#34;@/styles/*&#34;: [&#34;styles/*&#34;],</span>
<span class="code-block-extension-codeLine" data-line-num="7">      &#34;@/components/*&#34;: [&#34;components/*&#34;]</span>
<span class="code-block-extension-codeLine" data-line-num="8">    }</span>
<span class="code-block-extension-codeLine" data-line-num="9">  }</span>
<span class="code-block-extension-codeLine" data-line-num="10">}</span>
</code></pre>
...
<span class="code-block-extension-codeLine" data-line-num="2">import Button from &#39;@/components/button&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="3">import &#39;@/styles/styles.css&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="4">import Helper from &#39;utils/helper&#39;</span>
<span class="code-block-extension-codeLine" data-line-num="5"></span>
<span class="code-block-extension-codeLine" data-line-num="6">export default function HomePage() {</span>
<span class="code-block-extension-codeLine" data-line-num="7">  return (</span>
<span class="code-block-extension-codeLine" data-line-num="8">    <span class="xml">&lt;Helper&gt;</span></span>
<span class="code-block-extension-codeLine" data-line-num="9">      &lt;h1&gt;Hello World&lt;/h1&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="10">      &lt;Button /&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="11">    &lt;/Helper&gt;</span>
<span class="code-block-extension-codeLine" data-line-num="12">  )</span>
<span class="code-block-extension-codeLine" data-line-num="13">}</span>
</code></pre>

`@/The final address of components/button is actually src/components/button`, and the same applies to other addresses.

## 3. Src directory

Until now, we have always placed our code in the 'app' or 'pages' directory under the root directory, but NextJS also supports the' src 'directory. Placing code in the' src 'directory helps to separate application code from project configuration files (often in the project root directory).

Using the 'src' directory, move files under 'app' or 'pages' to' src/app 'or' src/pages':

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9ec8ac3a6b964518bf7a4919305f9b38~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=1600&h=687&s=330812&e=png&b=161616)

When adjusting, pay attention to:

*Continue to place the '/public' directory in the project root directory
*Continue to place configuration files such as' package. json ',' next. config. js', and 'tsconfig. json' in the project root directory
_Continue to place the. env. _ file in the project root directory
*If 'app' or 'pages' exist in the root directory,' src/app 'or' src/pages' will be ignored.
*If you are using src, you may also need to move other application folders such as/components or/lib`
*If you are using middleware, make sure it is placed in the 'src' directory
*If you are using Tailwind CSS, don't forget to modify the 'content' configuration item in 'tailwind.diag.js':

<pre><div class="code-block-extension-header"><div class="code-block-extension-headerLeft"><div class="code-block-extension-foldBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16.924 9.617A1 1 0 0 0 16 9H8a1 1 0 0 0-.707 1.707l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0 .217-1.09z" data-name="Down"></path></svg></div></div><div class="code-block-extension-headerRight"></div></div><code class="hljs language-javascript code-block-extension-codeShowNum"><span class="code-block-extension-codeLine" data-line-num="1">/** @type {import(&#39;tailwindcss&#39;).Config} */</span>
...
<span class="code-block-extension-codeLine" data-line-num="4">    &#39;./src/**/*.{html,js}&#39;,</span>
<span class="code-block-extension-codeLine" data-line-num="5">  ],</span>
<span class="code-block-extension-codeLine" data-line-num="6">  // ...</span>
<span class="code-block-extension-codeLine" data-line-num="7">}</span></code></pre>
